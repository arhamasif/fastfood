...
const SignUpCust = props =>
{
    ...
    {
        user.current.officelocation=enteredText;
    }
    ...
    return(
        ...
        <View style={styles.screen}>
            <Verification visible={isVisible} visibleFunc={removeVerification} navigation={navigation} signUpFrom="Cust"/>
            <View style={styles.outerBox}>
                ...
                <DataBox title="Office Location" inputData={locInputFunction} />
                <DataBox title="Department" inputData={deptInputFunction} />
            </View>
